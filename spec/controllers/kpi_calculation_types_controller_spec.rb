...
RSpec.describe KpiCalculationTypesController, :type => :controller do
	...
	describe "GET index" do
      context "when user is admin and logged in" do
            ...
            before do
               kpi_calculation_type = KpiCalculationType.create
              @user = create(:user)
            ...
            expect(kpi_calculation_types).to be_truthy
            end
  ...
  describe 'POST #create' do
    ...
    context 'with valid attributes' do
      it 'creates the kpi_calculation_type' do
        ...
        expect(KpiCalculationType.count).to eq(1)
      end
  ...
  describe "#update" do
          ...
          expect(flash[:success]).not_to eq("KPI Calculation Type was not updated.")
          expect(response).to redirect_to :back
          end
  end
