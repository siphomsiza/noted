module SessionsHelper
  ...
  def log_in(user)
    ...
    session[:session_poe_destination] = $poe_file_destination
    $current_session_db = session[:session_database]
    $poe_destination_path = session[:session_poe_destination]
  end
  ...
  def log_out
    ...
    session.delete(:session_poe_destination)
