...
set :linked_files, fetch(:linked_files, []).push('config/lepelle_nkumpi_db.yml','config/mkhondo_db.yml','config/sakhisizwe_db.yml','config/engcobo_db.yml','config/database.yml', 'config/secrets.yml')
